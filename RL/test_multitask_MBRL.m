...
switch params.env
    ...
    case 'puddle'
        ...
        params.N_state_dim= 2; %2;
        params.N_act = 4;
        params.s_init = [0.5;0.5]; %[1;1]; % Start in the top left corner
...
for ex=1:N_exec
    ...
    gpr_rew_stack.gp{1} = MBRL.onlineGP_MA_Scalar(params.N_act,params.rbf_mu,params.sigma,params.N_budget,params.tol,params.A);
    ...
    gpr_trans_stack.gp{1} = MBRL.onlineGP_MA_Vector(params.N_act,params.rbf_mu,params.sigma,params.N_budget,params.tol,params.N_state_dim);
